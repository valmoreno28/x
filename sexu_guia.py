...
if my_page == "VIH/SIDA":
	...
	st.write("")
	st.write("")
	st.write("La infección por el Virus de Inmunodeficiencia Humana (VIH) es causada por el virus del mismo nombre, el cual ataca al sistema inmunitario, debilitándolo y por ende haciendo al portador más propenso a adquirir infecciones o tipos de cáncer que el sistema por sí solo pudiese combatir, pero al verse comprometido este suele deteriorar su salud, haciendo caer a las personas en situaciones de los que se conoce como inmunodeficiencia. De una manera coloquial se puede mencionar que los guardianes de tu cuerpo caen y este se vuelve vulnerable ante las enfermedades.")
	st.write("")
	st.write("")
	st.write("Uno de los factores más preocupantes radica principalmente en el hecho de que la mayoría de las personas contagiadas empieza con síntomas graves de esta infección pueden tardar años en manifestarse, mientras al contrario de lo que se piensa en las primeras semanas los síntomas si llegaran a existir suelen presentarse como un cuadro gripal con fiebre, erupciones, dolor de cabeza y garganta. En etapas más avanzadas de la infección esta se comienza a presentar otro cuadro sintomático como diarrea, tos, inflamación de ganglios linfáticos y pérdida de peso. En etapas más avanzadas, la infección comienza a debilitar el sistema inmune del portador y de esta manera la adquisición de algunas infecciones bacterianas, tuberculosis, meningitis criptocócica, algunos tipos de cánceres.")
	st.write("")
	st.write("")
	st.subheader("¿Cómo se transmite?")
	st.write("")
	st.write("")
	st.write("La transmisión del VIH es principalmente en fluidos como la leche materna, sangre, semen y fluidos vaginales. Existe la posibilidad de transmisión de madre a hijo durante el embarazo y parto.")
	st.write("")
	st.write("")
	st.warning("¡OJO! No es posible la transmisión por contactos comunes como lo son los abrazos, saludos de mano ni besos o tampoco por compartir objetos personales como algún alimento o bebidas.")
	st.write("")
	st.write("")
	st.subheader("¿Qué te hace más propenso a contraer la infección por VIH?")
	st.write("")
	st.write("")
	st.write("✱Tener sexo vaginal o anal sin condón, incluso oral, aunque poco si se cuenta con lesiones potencialmente contagiosas como cortes en los tejidos involucrados.")
	st.write("")
	st.write("✱Presentar otras infecciones de transmisión sexual como gonorrea, clamidiasis, herpes, sífilis o alguna vaginosis bacteriana; esto se debe principalmente a que las personas que se encuentran infectadas por estas infecciones mantienen comportamientos no deseados en la práctica segura del coito, además si cuenta con alguna lesión ocasionada por estas mismas podría aumentar el riesgo de trasmisión.")
	st.write("")
	st.write("✱Tener múltiples parejas sexuales. ")
	st.write("")
	st.write("✱El consumo de drogas inyectables aumenta la posibilidad contagio ya que, al compartir jeringas, soluciones de droga u otro material con la capacidad de infectarte puedes contagiarte de VIH.")
	st.write("")
	st.write("✱Otro riesgo latente es la posibilidad de contagiarte por medio de transfusiones sanguíneas, trasplantes de tejidos o incluso inyecciones, esto cuando no se provee la seguridad de que estos no estén contaminados con el virus, o bien también si en una operación quirúrgica los instrumentos utilizados no se encuentran total y debidamente esterilizados.")
	st.write("")
	st.write("✱El herirte accidentalmente con agujas o algún objeto punzocortante contaminado.")
	st.write("")
	st.write("✱El hacerte tatuajes sin las debidas condiciones de esterilidad e higiene.")
	st.write("")
	st.write("✱El estar bajo el efecto de alguna sustancia como alcohol y drogas, disminuye la inhibición personal y aumenta la posibilidad de mantener prácticas sexuales riesgosas.")
	st.write("")
	st.write("")
	st.subheader("Diagnóstico")
	st.write("")
	st.write("El diagnóstico se puede realizar por medio de saliva o sangre, ya que esto radica principalmente por pruebas de antígenos y anticuerpos, por medio de métodos como el ELISA,  el cual consiste básicamente en la unión de antígenos a anticuerpos que tu cuerpo haya generado para combatir la infección, esto hará básicamente que la haya una reacción de unión de anticuerpos con el antígeno, lo cual se presentará como un caso positivo, mientras si no existieran los anticuerpos esto podría presentarse como VIH negativo.")
	st.write("")
	st.write("")
	st.subheader("Tratamiento")
	st.write("")
	st.write("Primero se debe saber que el virus de la inmunodeficiencia adquirida (VIH), hasta el día de hoy es incurable, pero con el tratamiento adecuado, la persona podrá llevar una buena calidad de vida. El tratamiento constará del consumo de fármacos antirretrovirales (TAR) los cuales actúan impidiendo que el virus siga multiplicándose y por ende el sistema inmune mejore su fortaleza y pueda hacer frente ante las infecciones que se pudiesen adquirir sin el tratamiento.")
	st.write("")
	st.write("")
	st.subheader("¿Puedo prevenirlo?")
	st.write("")
	st.write("✱Si, como en todas las infecciones de trasmisión sexual este se puede prevenir con el uso de condón ya sea masculino o femenino.")
	st.write("")
	st.write("✱Puedes evitar tener múltiples parejas sexuales.")
	st.write("")
	st.write("✱La circuncisión medica disminuye el riesgo.")
	st.write("")
	st.write("✱Tratar de prevenir la infección de madre al hijo antes, durante y después del embarazo.")
	st.write("")
	st.write("✱Según datos oficiales en algunos países como Estados Unidos, las parejas de hombres (sexo asignado al nacer) homosexuales aumenta el riesgo de contraer VIH, por lo cual un uso adecuado de preservativo, consumo de antirretrovirales como modo de prevención, pruebas de detección cada cierto periodo de tiempo, aunque estos últimos dos aplican para población en general de igual manera.")
	st.write("")
	st.write("✱Evitar el consumo de drogas inyectables.")
	st.write("")
	st.write("✱Informarse más acerca del tema.")
	st.write("")
	st.write("✱Y tener conciencia y consideración en caso de ser portador, hacérselo saber a tus pareja o parejas sexuales.")
	st.write("")
	st.write("")
	st.info("¡CUÍDATE Y CUIDA A LOS DEMÁS!")
	st.write("")
	st.write("")
